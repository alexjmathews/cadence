...
final class DesignTokensTests: XCTestCase {
    ...
    /// two extra footer rows D8 adds for `Settings…` and `Quit Cadence`. (The mockup
    /// itself measures 288 × 284; §6 gives this document the width.)
    func testDropdownRhythmComposesToTheBuiltSheet() {
        ...
        let height = Sheet.topPadding + Sheet.headerHeight
            ...
            + DesignTokens.Component.hairlineWidth
            + 3 * Sheet.footerHeight
        XCTAssertEqual(height, 363)
